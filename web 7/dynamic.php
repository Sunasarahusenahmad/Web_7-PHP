...
<body>
    ...
    <nav>
        <div class="container">
            <div>
                <h1
                    style="margin-top: 15px; margin-left: 60px; font-size: xx-large; font-family: 'Courier New', Courier, monospace;">
                    <a href="index,.html"> <img src="logo.png" alt="" height="50px" width="200px"> </a></h1>
            </div>
            ...
            <div class="fs2">
                ...
                <div style="display: flex; margin-left: 70px; margin-top: 10px;">
                    <div style="width: 50%; padding:3;">
                        <input type="text" name="fname" id="fname" style="padding: 10px; width: 200px;">
                    </div>
                    <div style="width: 50%; padding: 3px;">
                        <input type="text" name="lname" id="lname" style="padding: 10px; width: 200px;" >
                    </div>
                </div>

                <span class="fs3">Address </span>
                <div style="margin-top: 10px; padding-bottom: 10px;">
                    <input type="text" name="address" id="address" style="padding: 10px; width: 470px; margin-left: 70px; ">
                </div>

                <span class="fs3" >E-mail </span>
                <div style="margin-top: 10px;">
                    <input type="email" name="email" id="email" style="padding: 10px; width: 470px; margin-left: 70px; ">
                </div>

                <div class="fsbtn">
                    <input class="btn2" type="submit" name="submit" value="Submit your Information">
                </div>
            </form>
            </div>
        </div>
